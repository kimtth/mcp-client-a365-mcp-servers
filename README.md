...
- **Agent blueprint app**: created by `a365 setup blueprint`; stored in `ToolingManifest.json`; used for gateway discovery headers and agent-scoped metadata lookup
